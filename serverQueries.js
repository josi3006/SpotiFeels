...
// coping playlist ----->
var accessToken = "BQBxRmORPX-qMcwZxpr5uihueqIWYIjBiNiQTFN5nlhZwHgQ8l3nrX513u3V5nMtiS5N1XuOFHflSHv-ufU";
const fetch = require('node-fetch');
...
var stringThere =  insert.substring(0, insert.indexOf(",")) + "'" + insert.substring(insert.indexOf(","), (insert.indexOf(",")+1)) + "'" + insert.substring((insert.indexOf(",")+ 2), insert.length) ;
